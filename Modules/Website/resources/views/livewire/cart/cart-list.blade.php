            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                ...
                <div class="lg:col-span-8 space-y-6">
                    ...
                    @php
                        ...
                        $percent = min(100, ($subtotal / $freeShippingThreshold) * 100);
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 divide-y divide-gray-100 overflow-hidden">
                        @foreach($this->cartData['items'] as $item)
                            <div class="p-6 flex gap-6 group transition hover:bg-gray-50/50" wire:key="item-{{ $item->id }}">
                                ...
                                <div class="flex-1 flex flex-col justify-between">
                                    ...
                                    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mt-4">
                                        ...
                                        <div class="flex items-center bg-white border border-gray-300 rounded-lg w-fit shadow-sm">
                                            <button wire:click="decrement({{ $item->id }})" class="w-8 h-8 flex items-center justify-center text-gray-500 hover:bg-gray-100 hover:text-gray-900 rounded-l-lg transition">-</button>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100">
                        ...
                        <div class="space-y-4 text-sm">
                            ...
                            <div class="flex justify-between items-end">
                                ...
                                <span class="text-2xl font-black text-blue-600 tracking-tight">{{ number_format($this->cartData['subtotal']) }}đ</span>
                            </div>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-100">
                            <div class="relative">
                                <input type="text" placeholder="Mã giảm giá" class="w-full bg-gray-50 border border-gray-200 rounded-lg py-2.5 pl-4 pr-12 text-sm focus:ring-2 focus:ring-blue-500 focus:bg-white transition">
                                <button class="absolute right-2 top-1/2 -translate-y-1/2 text-xs font-bold text-blue-600 hover:text-blue-700 px-2">Áp dụng</button>
                            </div>
                        </div>
