<div class="space-y-8">
    ...
    <form wire:submit="placeOrder" class="space-y-8">
        ...
        <section class="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    @error('customer_name') <span class="text-red-500 text-xs flex items-center gap-1"><svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>{{ $message }}</span> @enderror
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" wire:model="customer_phone" 
                           ...
                           placeholder="Ví dụ: 0903..." maxlength="12">
                ...
                <label class="relative flex items-center p-4 border rounded-xl cursor-pointer hover:bg-gray-50 transition-all duration-200 group {{ $payment_method === 'momo' ? 'border-pink-600 bg-pink-50/30 ring-1 ring-pink-600' : 'border-gray-200' }}">
                    ...
                    <div class="flex items-center gap-4 w-full">
                        <div class="w-10 h-10 rounded-lg overflow-hidden shrink-0 border border-gray-100">
                            <img src="https://developers.momo.vn/v3/img/logo.svg" class="w-full h-full object-cover p-1">
                        </div>
                        <div>
        ...
        <button type="submit" 
            ...
            {{-- Loading State --}}
            <div wire:loading class="absolute inset-0 flex items-center justify-center bg-gray-800">
