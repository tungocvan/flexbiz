...
<header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm transition-all duration-300"
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 md:h-20 gap-4">
            ...
            <div class="flex items-center gap-3 md:gap-8">
                ...
                <a href="/" class="flex-shrink-0 flex items-center gap-2 group">
                    <div class="w-8 h-8 md:w-10 md:h-10 bg-black text-white rounded-lg flex items-center justify-center font-black text-lg md:text-xl group-hover:bg-blue-600 transition-colors">F</div>
                    <span class="text-xl md:text-2xl font-bold text-gray-900 tracking-tight group-hover:text-blue-600 transition-colors">FlexBiz<span class="text-blue-600 group-hover:text-black">.</span></span>
                </a>
            </div>
                    ...
                    <div class="hidden lg:block relative">
                        @auth
                            ...
                            <div x-show="userDropdownOpen"
                                ...
                                <div class="py-1">
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">Hồ sơ cá nhân</a>
                                    <a href="{{ route('account.orders') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">Đơn hàng của tôi</a>
                                </div>
        ...
        <div x-show="mobileSearchOpen"
             ...
             class="lg:hidden pb-4" style="display: none;">
    ...
    <div x-show="mobileMenuOpen" class="lg:hidden fixed inset-0 z-[60]" style="display: none;">
        ...
        <div x-show="mobileMenuOpen"
             ...
             class="relative bg-white w-[85%] max-w-sm h-full shadow-2xl overflow-y-auto">
            ...
            <div class="p-4 space-y-1">
                <a href="/" class="block px-4 py-3 text-gray-700 font-medium hover:bg-gray-50 rounded-xl hover:text-blue-600 transition flex items-center gap-3">
                ...
                <a href="{{ route('product.list') }}" class="block px-4 py-3 text-gray-700 font-medium hover:bg-gray-50 rounded-xl hover:text-blue-600 transition flex items-center gap-3">
                ...
                <a href="{{ route('blog.index') }}" class="block px-4 py-3 text-gray-700 font-medium hover:bg-gray-50 rounded-xl hover:text-blue-600 transition flex items-center gap-3">
                ...
                @auth
                    <div class="border-t border-gray-100 my-2 pt-2">
                        ...
                        <a href="#" class="block px-4 py-3 text-gray-700 font-medium hover:bg-gray-50 rounded-xl hover:text-blue-600 transition">Hồ sơ cá nhân</a>
                        <a href="{{ route('account.orders') }}" class="block px-4 py-3 text-gray-700 font-medium hover:bg-gray-50 rounded-xl hover:text-blue-600 transition">Đơn hàng của tôi</a>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
            ...
            {{-- Contact Info (Đưa từ Topbar xuống đây) --}}
            <div class="p-6 bg-gray-50 mt-auto border-t border-gray-100">
                ...
                <div class="space-y-3 text-sm text-gray-600">
                    ...
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        tungocvan@gmail.com
                    </div>
                </div>
            </div>
